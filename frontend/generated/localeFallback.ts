...
export const LOCALE_FALLBACK: Record<'zh' | 'en', Record<string, string>> = {
  "zh": {
    ...
    "ai_helper_admin_jailbreak_filter_less": "收起高级筛选",
    "ai_helper_admin_jailbreak_filter_more": "更多筛选（已启用 {0} 项）",
    "ai_helper_admin_jailbreak_filter_more_region": "高级筛选条件",
    "ai_helper_admin_jailbreak_filter_problem": "题目 ID",
    "ai_helper_admin_jailbreak_filter_problem_placeholder": "输入部分题目 ID",
    "ai_helper_admin_jailbreak_filter_reset": "重置筛选",
    "ai_helper_admin_jailbreak_filter_review_status": "复核状态",
    "ai_helper_admin_jailbreak_filter_source": "检测来源",
    "ai_helper_admin_jailbreak_filter_source_help": "表示触发命中的文本视图；“自定义规则”特指自定义规则在标准化原文中命中。",
    "ai_helper_admin_jailbreak_filter_suggestions_failed": "加载学生或题目候选项失败",
    "ai_helper_admin_jailbreak_filter_suggestions_invalid": "学生或题目候选项查询无效",
    "ai_helper_admin_jailbreak_filter_suggestions_rate_limited": "候选项查询过于频繁，请稍后再试",
    "ai_helper_admin_jailbreak_filter_title": "筛选记录",
    "ai_helper_admin_jailbreak_filter_user": "学生 ID",
    "ai_helper_admin_jailbreak_filter_user_placeholder": "输入部分学生 ID",
    ...
    "ai_helper_admin_jailbreak_source_base64": "Base64 解码内容",
    "ai_helper_admin_jailbreak_source_compacted": "去除分隔符后的文本",
    "ai_helper_admin_jailbreak_source_conversation": "多轮会话组合",
    "ai_helper_admin_jailbreak_source_custom": "自定义规则（标准化原文命中）",
    "ai_helper_admin_jailbreak_source_hex": "Hex 解码内容",
    "ai_helper_admin_jailbreak_source_plain": "标准化原始文本",
    ...
    "ai_helper_safety_analytics_load_error": "统计数据加载失败：{0}",
    "ai_helper_safety_analytics_loading": "正在加载统计数据…",
    "ai_helper_safety_analytics_no_operations": "暂无运营指标。",
    "ai_helper_safety_analytics_no_rule_quality": "暂无规则质量数据。",
    "ai_helper_safety_analytics_no_trend": "最近没有可展示的每日趋势。",
    "ai_helper_safety_analytics_operations_desc": "观察近期事件、冷却处置、申诉与处理时效。",
    "ai_helper_safety_analytics_operations_title": "近期运营指标",
    "ai_helper_safety_analytics_overview_desc": "汇总全部安全事件的复核状态，不受事件记录页筛选条件影响。",
    "ai_helper_safety_analytics_overview_title": "安全态势概览",
    "ai_helper_safety_analytics_retry": "重新加载统计数据",
    "ai_helper_safety_analytics_rule_quality_desc": "按误报数和命中量识别需要优先调整的检测规则。",
    ...
    "ai_helper_safety_records_bulk_title": "批量复核",
    "ai_helper_safety_records_filter_desc": "先缩小查询范围，再在下方记录列表中逐条或批量复核。",
    "ai_helper_safety_records_list_desc": "仅展示符合当前筛选条件的安全事件和复核操作。",
    ...
    "ai_helper_safety_section_analytics": "统计分析",
    "ai_helper_safety_section_events": "安全事件",
    "ai_helper_safety_section_records": "事件记录",
    ...
    "ai_helper_teaching_review_ai_users": "AI 使用",
    "ai_helper_teaching_review_attention": "一般",
    "ai_helper_teaching_review_empty": "暂无教学总结记录",
    "ai_helper_teaching_review_failed_hint": "本次总结生成失败，可进入教学分析重新生成",
    "ai_helper_teaching_review_feedback": "总结反馈",
    "ai_helper_teaching_review_focus": "重点",
    "ai_helper_teaching_review_helpful": "有帮助",
    "ai_helper_teaching_review_load_failed": "教学总结加载失败",
    "ai_helper_teaching_review_loading": "正在加载教学总结…",
    "ai_helper_teaching_review_no_findings": "暂无重点问题",
    "ai_helper_teaching_review_not_helpful": "没帮助",
    "ai_helper_teaching_review_observation": "观察",
    "ai_helper_teaching_review_participated": "参与",
    "ai_helper_teaching_review_positive_rate": "{0}% 有帮助",
    "ai_helper_teaching_review_primary_finding": "主要问题",
    "ai_helper_teaching_review_refresh": "刷新",
    "ai_helper_teaching_review_retry": "重试",
    "ai_helper_teaching_review_status_completed": "已完成",
    "ai_helper_teaching_review_status_failed": "生成失败",
    "ai_helper_teaching_review_status_generating": "生成中",
    "ai_helper_teaching_review_status_pending": "等待生成",
    "ai_helper_teaching_review_total": "共 {0} 条记录",
    "ai_helper_teaching_review_unrated": "未评价",
    "ai_helper_teaching_review_view": "查看分析",
    ...
    "ai_helper_testdata_background_active": "任务已在后台运行。可以关闭或离开本页面；重新进入该题文件页时会自动恢复进度或结果。",
    "ai_helper_testdata_background_starting": "正在创建后台任务，请稍候；任务创建完成后即可安全离开页面。",
    ...
    "ai_helper_testdata_cancel": "取消生成",
    "ai_helper_testdata_canceling": "正在取消…",
    ...
    "ai_helper_testdata_err_canceled": "已取消本次生成；已经发出的模型请求仍可能产生费用",
    ...
    "ai_helper_testdata_err_invalid_generation_profile": "无效的生成等待方式",
    ...
    "ai_helper_testdata_err_timeout_profile": "生成已达到当前模式约 {0} 分钟的等待上限，请调整模式或模型后重试",
    ...
    "ai_helper_testdata_generating_hint": "生成不限输出长度，深度思考模型可能需要数分钟；任务会在后台继续",
    "ai_helper_testdata_generating_hint_hard": "高难题模式最长约 {0} 分钟；长时间停在同一阶段并不代表页面卡死",
    "ai_helper_testdata_generating_hint_standard": "普通题模式最长约 {0} 分钟；百分比是阶段估算，不代表模型内部完成比例",
    "ai_helper_testdata_job_failed": "后台生成任务失败，请重试",
    "ai_helper_testdata_job_interrupted": "生成服务在任务执行期间重启或失去连接。为避免重复计费，系统没有自动重跑，请手动重新生成。",
    "ai_helper_testdata_job_not_found": "生成任务不存在、已过期或无权访问",
    "ai_helper_testdata_job_result_unavailable": "该生成任务尚未完成，或结果与当前题目不匹配",
    "ai_helper_testdata_job_start_failed": "后台生成任务创建失败，请重试",
    ...
    "ai_helper_testdata_profile_hard": "高难题（约 30 分钟）",
    "ai_helper_testdata_profile_hard_hint": "适合需要长时间算法推导的竞赛题：单个模型最多等待 20 分钟，整次生成最多约 30 分钟。",
    "ai_helper_testdata_profile_hard_warning": "高难题模式会延长付费模型调用和页面等待时间，但不能替代可靠标程与人工复核。",
    "ai_helper_testdata_profile_label": "生成等待方式",
    "ai_helper_testdata_profile_standard": "普通题（约 15 分钟）",
    "ai_helper_testdata_profile_standard_hint": "适合多数题目：单个模型最多等待 10 分钟，整次生成最多约 15 分钟。",
    ...
    "ai_helper_testdata_progress_last_update": "距上次后台阶段更新 {0}:{1}",
    "ai_helper_testdata_progress_live": "后台阶段状态（百分比为估算）",
    "ai_helper_testdata_progress_model_escalation": "首选模型未通过验证，正在切换下一模型完整重跑",
    "ai_helper_testdata_progress_model_fallback": "当前模型响应失败，正在尝试后备模型",
    ...
    "ai_helper_testdata_progress_waiting_long": "这一阶段耗时较长，系统仍在等待模型返回完整结果。您可以继续等待，或取消后改用高难题模式、后备模型或可靠标程。",
  ...
  "en": {
    ...
    "ai_helper_admin_jailbreak_filter_less": "Hide advanced filters",
    "ai_helper_admin_jailbreak_filter_more": "More filters ({0} active)",
    "ai_helper_admin_jailbreak_filter_more_region": "Advanced filter conditions",
    "ai_helper_admin_jailbreak_filter_problem": "Problem ID",
    "ai_helper_admin_jailbreak_filter_problem_placeholder": "Enter part of a problem ID",
    "ai_helper_admin_jailbreak_filter_reset": "Reset filters",
    "ai_helper_admin_jailbreak_filter_review_status": "Review status",
    "ai_helper_admin_jailbreak_filter_source": "Detection source",
    "ai_helper_admin_jailbreak_filter_source_help": "The text view that triggered the match; Custom rule specifically means a custom rule matched normalized original text.",
    "ai_helper_admin_jailbreak_filter_suggestions_failed": "Failed to load student or problem suggestions",
    "ai_helper_admin_jailbreak_filter_suggestions_invalid": "Invalid student or problem suggestion query",
    "ai_helper_admin_jailbreak_filter_suggestions_rate_limited": "Too many suggestion requests; try again shortly",
    "ai_helper_admin_jailbreak_filter_title": "Filter records",
    "ai_helper_admin_jailbreak_filter_user": "Student ID",
    "ai_helper_admin_jailbreak_filter_user_placeholder": "Enter part of a student ID",
    ...
    "ai_helper_admin_jailbreak_source_base64": "Base64-decoded content",
    "ai_helper_admin_jailbreak_source_compacted": "Text with separators removed",
    "ai_helper_admin_jailbreak_source_conversation": "Combined conversation turns",
    "ai_helper_admin_jailbreak_source_custom": "Custom rule (normalized original text)",
    "ai_helper_admin_jailbreak_source_hex": "Hex-decoded content",
    "ai_helper_admin_jailbreak_source_plain": "Normalized original text",
    ...
    "ai_helper_safety_analytics_load_error": "Failed to load analytics: {0}",
    "ai_helper_safety_analytics_loading": "Loading analytics…",
    "ai_helper_safety_analytics_no_operations": "No operational metrics are available.",
    "ai_helper_safety_analytics_no_rule_quality": "No rule-quality data is available.",
    "ai_helper_safety_analytics_no_trend": "No daily trend is available for the recent period.",
    "ai_helper_safety_analytics_operations_desc": "Track recent events, cooldown actions, appeals, and handling times.",
    "ai_helper_safety_analytics_operations_title": "Recent operational metrics",
    "ai_helper_safety_analytics_overview_desc": "Summarizes all safety events and is not affected by filters on the event records tab.",
    "ai_helper_safety_analytics_overview_title": "Safety posture overview",
    "ai_helper_safety_analytics_retry": "Reload analytics",
    "ai_helper_safety_analytics_rule_quality_desc": "Identify detection rules that need attention based on false positives and match volume.",
    ...
    "ai_helper_safety_records_bulk_title": "Bulk review",
    "ai_helper_safety_records_filter_desc": "Narrow the query first, then review matching records individually or in bulk below.",
    "ai_helper_safety_records_list_desc": "Only safety events and review actions matching the current filters appear here.",
    ...
    "ai_helper_safety_section_analytics": "Analytics",
    "ai_helper_safety_section_events": "Safety Events",
    "ai_helper_safety_section_records": "Event Records",
    ...
    "ai_helper_teaching_review_ai_users": "AI users",
    "ai_helper_teaching_review_attention": "Attention",
    "ai_helper_teaching_review_empty": "No teaching summaries yet",
    "ai_helper_teaching_review_failed_hint": "Generation failed; open the analysis to try again",
    "ai_helper_teaching_review_feedback": "Summary feedback",
    "ai_helper_teaching_review_focus": "Priority",
    "ai_helper_teaching_review_helpful": "Helpful",
    "ai_helper_teaching_review_load_failed": "Failed to load teaching summaries",
    "ai_helper_teaching_review_loading": "Loading teaching summaries…",
    "ai_helper_teaching_review_no_findings": "No priority findings",
    "ai_helper_teaching_review_not_helpful": "Not helpful",
    "ai_helper_teaching_review_observation": "Observation",
    "ai_helper_teaching_review_participated": "Participants",
    "ai_helper_teaching_review_positive_rate": "{0}% helpful",
    "ai_helper_teaching_review_primary_finding": "Main finding",
    "ai_helper_teaching_review_refresh": "Refresh",
    "ai_helper_teaching_review_retry": "Retry",
    "ai_helper_teaching_review_status_completed": "Completed",
    "ai_helper_teaching_review_status_failed": "Failed",
    "ai_helper_teaching_review_status_generating": "Generating",
    "ai_helper_teaching_review_status_pending": "Waiting",
    "ai_helper_teaching_review_total": "{0} records",
    "ai_helper_teaching_review_unrated": "Not rated",
    "ai_helper_teaching_review_view": "View analysis",
    ...
    "ai_helper_testdata_background_active": "This task is running in the background. You may close or leave this page; returning to the problem files page restores its progress or result.",
    "ai_helper_testdata_background_starting": "Creating the background task. Once it is ready, you can safely leave this page.",
    ...
    "ai_helper_testdata_cancel": "Cancel generation",
    "ai_helper_testdata_canceling": "Canceling…",
    ...
    "ai_helper_testdata_err_canceled": "Generation canceled. Model requests already sent may still incur charges.",
    ...
    "ai_helper_testdata_err_invalid_generation_profile": "Invalid generation wait mode",
    ...
    "ai_helper_testdata_err_timeout_profile": "Generation reached this mode's approximate {0}-minute limit. Adjust the mode or model and try again.",
    ...
    "ai_helper_testdata_generating_hint": "Output length is unrestricted; deep-thinking models may take several minutes. The task continues in the background.",
    "ai_helper_testdata_generating_hint_hard": "Hard-problem mode may take up to about {0} minutes; staying on one stage for a while does not necessarily mean the page is stuck.",
    "ai_helper_testdata_generating_hint_standard": "Standard mode may take up to about {0} minutes; the percentage estimates pipeline stages, not the model's internal completion.",
    "ai_helper_testdata_job_failed": "The background generation task failed. Please try again.",
    "ai_helper_testdata_job_interrupted": "The generation service restarted or lost its worker during this task. To avoid duplicate charges, it was not restarted automatically; please start it again manually.",
    "ai_helper_testdata_job_not_found": "This generation task does not exist, has expired, or is not accessible.",
    "ai_helper_testdata_job_result_unavailable": "This generation task is not complete, or its result does not belong to the current problem.",
    "ai_helper_testdata_job_start_failed": "Could not create the background generation task. Please try again.",
    ...
    "ai_helper_testdata_profile_hard": "Hard problem (about 30 min)",
    "ai_helper_testdata_profile_hard_hint": "For contest problems requiring long algorithmic reasoning: up to 20 minutes per model and about 30 minutes for the full run.",
    "ai_helper_testdata_profile_hard_warning": "Hard-problem mode extends paid model calls and page wait time, but it does not replace a trusted reference solution or manual review.",
    "ai_helper_testdata_profile_label": "Generation wait mode",
    "ai_helper_testdata_profile_standard": "Standard (about 15 min)",
    "ai_helper_testdata_profile_standard_hint": "For most problems: up to 10 minutes per model and about 15 minutes for the full run.",
    ...
    "ai_helper_testdata_progress_last_update": "Last server stage update {0}:{1} ago",
    "ai_helper_testdata_progress_live": "Server pipeline stage (percentage is estimated)",
    "ai_helper_testdata_progress_model_escalation": "The first model failed verification; rerunning with the next model",
    "ai_helper_testdata_progress_model_fallback": "The current model failed to respond; trying a backup model",
    ...
    "ai_helper_testdata_progress_waiting_long": "This stage is taking longer than usual while the system waits for a complete model response. You can keep waiting, or cancel and use hard-problem mode, a backup model, or a trusted reference solution.",
