...
export const LOCALE_FALLBACK: Record<'zh' | 'en', Record<string, string>> = {
  "zh": {
    ...
    "ai_helper_testdata_benchmark_canceled": "基准运行已取消；已经发出的模型请求仍可能产生费用。",
    "ai_helper_testdata_benchmark_case_connectivity": "带删除的动态连通性（回滚并查集）",
    "ai_helper_testdata_benchmark_case_segment": "区间翻转与最长连续 1（懒标记线段树）",
    "ai_helper_testdata_benchmark_case_xor": "子数组异或小于 K（二进制 Trie）",
    "ai_helper_testdata_benchmark_confirm": "将真实调用已配置的付费模型运行 {0} 道难题，可能持续数分钟并产生费用。确认开始吗？",
    "ai_helper_testdata_benchmark_confirm_required": "必须明确确认可能产生的真实模型费用",
    "ai_helper_testdata_benchmark_cost_warning": "此操作会真实调用付费模型，而且每道题包含多阶段生成、独立验证与可能的模型升级，费用和等待时间会明显高于普通对话。",
    "ai_helper_testdata_benchmark_desc": "使用已保存的“测试数据生成”场景模型链和 Hydro 沙箱，运行固定难题与模型不可见的隐藏探针。修改配置后请先保存再运行。",
    "ai_helper_testdata_benchmark_download_aggregate": "下载隐私安全汇总",
    "ai_helper_testdata_benchmark_download_full": "下载完整报告",
    "ai_helper_testdata_benchmark_failed": "真实模型基准运行失败",
    "ai_helper_testdata_benchmark_no_result": "基准进度流结束，但未收到最终报告",
    "ai_helper_testdata_benchmark_privacy": "结果只返回当前浏览器，不写入数据库、不自动上传。完整报告包含生成代码与隐藏探针结果；对外分享请优先使用隐私安全汇总。",
    "ai_helper_testdata_benchmark_progress": "第 {0}/{1} 题：{2}",
    "ai_helper_testdata_benchmark_rate_limited": "真实模型基准每小时最多运行 2 次，请稍后再试",
    "ai_helper_testdata_benchmark_run": "运行真实模型基准",
    "ai_helper_testdata_benchmark_running": "基准运行中…",
    "ai_helper_testdata_benchmark_sandbox_unavailable": "Hydro go-judge 沙箱不可用，无法运行正确性基准",
    "ai_helper_testdata_benchmark_select_case": "请至少选择一道基准题。",
    "ai_helper_testdata_benchmark_summary": "通过 {0}/{1}，通过率 {2}%",
    "ai_helper_testdata_benchmark_title": "真实付费模型基准",
    "ai_helper_testdata_benchmark_usage": "总耗时 {0} 秒 · 共 {1} tokens · 模型链 {2}",
  ...
  "en": {
    ...
    "ai_helper_testdata_benchmark_canceled": "Benchmark canceled. Model requests already sent may still incur charges.",
    "ai_helper_testdata_benchmark_case_connectivity": "Dynamic connectivity with deletions (rollback DSU)",
    "ai_helper_testdata_benchmark_case_segment": "Range flips and longest run of ones (lazy segment tree)",
    "ai_helper_testdata_benchmark_case_xor": "Subarray XOR less than K (binary trie)",
    "ai_helper_testdata_benchmark_confirm": "This will make real paid-model calls for {0} hard case(s), may run for several minutes, and will incur cost. Start now?",
    "ai_helper_testdata_benchmark_confirm_required": "Explicit confirmation of possible live-model charges is required",
    "ai_helper_testdata_benchmark_cost_warning": "This makes real paid-model calls. Each case includes multi-stage generation, independent verification, and possible model escalation, so cost and wait time can be much higher than a normal chat request.",
    "ai_helper_testdata_benchmark_desc": "Runs fixed hard problems and model-hidden probes with the saved Test Data Generation model chain and Hydro sandbox. Save configuration changes before running.",
    "ai_helper_testdata_benchmark_download_aggregate": "Download privacy-safe summary",
    "ai_helper_testdata_benchmark_download_full": "Download full report",
    "ai_helper_testdata_benchmark_failed": "The live-model benchmark failed",
    "ai_helper_testdata_benchmark_no_result": "The benchmark progress stream ended without a final report",
    "ai_helper_testdata_benchmark_privacy": "Results are returned only to this browser, not stored or uploaded automatically. The full report contains generated code and hidden-probe results; prefer the privacy-safe summary when sharing externally.",
    "ai_helper_testdata_benchmark_progress": "Case {0}/{1}: {2}",
    "ai_helper_testdata_benchmark_rate_limited": "The live-model benchmark can run at most twice per hour. Try again later.",
    "ai_helper_testdata_benchmark_run": "Run live-model benchmark",
    "ai_helper_testdata_benchmark_running": "Benchmark running…",
    "ai_helper_testdata_benchmark_sandbox_unavailable": "The Hydro go-judge sandbox is unavailable, so the correctness benchmark cannot run",
    "ai_helper_testdata_benchmark_select_case": "Select at least one benchmark case.",
    "ai_helper_testdata_benchmark_summary": "Passed {0}/{1} ({2}%)",
    "ai_helper_testdata_benchmark_title": "Live paid-model benchmark",
    "ai_helper_testdata_benchmark_usage": "Total {0}s · {1} tokens · model chain {2}",
